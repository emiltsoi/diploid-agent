...
def main() -> int:
    ...
    poller = TelegramPoller(
        ...
        attachments_enabled=config.harness.telegram.attachments_enabled,
        attachments_max_bytes=config.harness.telegram.attachments_max_bytes,
        attachments_dirname=config.harness.telegram.attachments_dirname,
        stt_provider=config.harness.telegram.stt_provider,
        stt_model=config.harness.telegram.stt_model,
        stt_command=config.harness.telegram.stt_command,
        tts_provider=config.harness.telegram.tts_provider,
        tts_model_path=config.harness.telegram.tts_model_path,
        tts_command=config.harness.telegram.tts_command,
        tts_max_chars=config.harness.telegram.tts_max_chars,
