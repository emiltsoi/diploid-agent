    ...
    def __init__(
        ...
        *,
        ...
        self._client = AcpClient(
            ...
            acp_resume_max_retries=config.acp_resume_max_retries,
            acp_resume_retry_base_seconds=config.acp_resume_retry_base_seconds,
            acp_resume_retry_max_seconds=config.acp_resume_retry_max_seconds,
