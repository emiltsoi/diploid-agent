...
servers and reusable skills, robust ACP transport recovery with ACP session
resume, and a rich plugin lifecycle hook surface for intercepting and extending
conversations.
